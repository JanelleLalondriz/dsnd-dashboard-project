...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        counts = model.event_counts(asset_id)
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        if model.name == "team": pred = probabilities.mean()
        else: pred = probabilities[0]
...
app, rt = fast_app(hdrs=(Link(rel="stylesheet", href="/assets/report.css"),), static_path=str(PROJECT_ROOT))
